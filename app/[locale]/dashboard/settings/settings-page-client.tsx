          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-secondary/20 rounded-lg border border-border/30 hover:border-primary/30 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold uppercase text-sm tracking-wider">{t('expiringMemberships')}</p>
                  <p className="text-xs text-muted-foreground mt-1">
                    {t('expiringMembershipsDesc')}
                  </p>
                </div>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-4 bg-secondary/20 rounded-lg border border-border/30 hover:border-primary/30 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold uppercase text-sm tracking-wider">{t('paymentsReceived')}</p>
                  <p className="text-xs text-muted-foreground mt-1">
            ...
            <div className="flex items-center justify-between p-4 bg-secondary/20 rounded-lg border border-border/30 hover:border-primary/30 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold uppercase text-sm tracking-wider">{t('memberCheckIns')}</p>
                  <p className="text-xs text-muted-foreground mt-1">
                    {t('memberCheckInsDesc')}
                  </p>
                </div>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-4 bg-secondary/20 rounded-lg border border-border/30 hover:border-primary/30 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold uppercase text-sm tracking-wider">{t('newRegistrations')}</p>
                  <p className="text-xs text-muted-foreground mt-1">
                    {t('newRegistrationsDesc')}
                  </p>
                </div>
              </div>
              <Switch

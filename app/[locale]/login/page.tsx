    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative">
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2 uppercase text-xs tracking-widest">{t('loginSubtitle')}</p>
        </div>

        {/* Login card */}
        <Card className="card-cyber border-border/50">
          <CardHeader>
            <CardTitle className="text-2xl tracking-wider uppercase">{t('signIn')}</CardTitle>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="uppercase text-xs tracking-wider">{t('email')}</Label>
                <Input
                  id="email"
                  type="email"
              ...
              <div className="space-y-2">
                <Label htmlFor="password" className="uppercase text-xs tracking-wider">{t('password')}</Label>
                <Input
                  id="password"
                  type="password"
                  placeholder="••••••••"

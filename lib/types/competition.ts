/**
 * Competition / challenges gamification. Aligned with tables competitions, competition_gyms, challenges, challenge_gym_scores.
 */
...
export type CompetitionListRow = Competition & {
  gyms?: CompetitionGym[]
}
